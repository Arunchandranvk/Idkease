# Generated by Django 5.0.3 on 2024-05-01 14:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Ward Member', 'Ward Member'), ('Users', 'Users')], default='Users', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.CharField(choices=[('Accept', 'Accept'), ('Reject', 'Reject'), ('Not Available', 'Not Available')], default='Not Available', max_length=100, null=True)),
                ('authority', models.CharField(choices=[('Accept', 'Accept'), ('Reject', 'Reject'), ('Not Available', 'Not Available')], default='Not Available', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complaint_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.complaint')),
            ],
        ),
    ]

...
--
-- Table structure for table `accounts_custuser`
--

DROP TABLE IF EXISTS `accounts_custuser`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `accounts_custuser` (
...
--
-- Dumping data for table `accounts_custuser`
--
